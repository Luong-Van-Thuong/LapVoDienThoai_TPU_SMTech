...
//                        reusableBitmap = new Bitmap(width, height, PixelFormat.Format8bppIndexed);

//                        ColorPalette palette = reusableBitmap.Palette;
//                        for (int i = 0; i < 256; i++)
//                            palette.Entries[i] = Color.FromArgb(i, i, i);
//                        reusableBitmap.Palette = palette;
...
//                BitmapData bmpData = reusableBitmap.LockBits(new Rectangle(0, 0, reusableBitmap.Width, reusableBitmap.Height),ImageLockMode.WriteOnly,PixelFormat.Format8bppIndexed);

//                Marshal.Copy((byte[])grabResult.PixelData, 0, bmpData.Scan0, imageBuffer.Length);

//                reusableBitmap.UnlockBits(bmpData);
//                Image_BASLER = (Bitmap)reusableBitmap.Clone();
